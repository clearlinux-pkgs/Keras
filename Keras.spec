...
Version  : 2.0.7
Release  : 11
URL      : http://pypi.debian.net/Keras/Keras-2.0.7.tar.gz
Source0  : http://pypi.debian.net/Keras/Keras-2.0.7.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1503409565
