...
Version  : 2.1.4
Release  : 23
URL      : http://pypi.debian.net/Keras/Keras-2.1.4.tar.gz
Source0  : http://pypi.debian.net/Keras/Keras-2.1.4.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1518579852
