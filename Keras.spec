...
Version  : 2.1.0
Release  : 17
URL      : http://pypi.debian.net/Keras/Keras-2.1.0.tar.gz
Source0  : http://pypi.debian.net/Keras/Keras-2.1.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1510659315
